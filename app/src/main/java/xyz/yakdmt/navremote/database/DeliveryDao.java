...
public class DeliveryDao extends AbstractDao<Delivery, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Tl_number = new Property(23, String.class, "tl_number", false, "TL_NUMBER");
        public final static Property Tl_transport_type = new Property(24, String.class, "tl_transport_type", false, "TL_TRANSPORT_TYPE");
        public final static Property Tl_transport_number = new Property(25, String.class, "tl_transport_number", false, "TL_TRANSPORT_NUMBER");
        public final static Property Container_number = new Property(26, String.class, "container_number", false, "CONTAINER_NUMBER");
        public final static Property Wagon_number = new Property(27, String.class, "wagon_number", false, "WAGON_NUMBER");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DELIVERY\" (" + //
                ...
                "\"TL_NUMBER\" TEXT," + // 23: tl_number
                "\"TL_TRANSPORT_TYPE\" TEXT," + // 24: tl_transport_type
                "\"TL_TRANSPORT_NUMBER\" TEXT," + // 25: tl_transport_number
                "\"CONTAINER_NUMBER\" TEXT," + // 26: container_number
                "\"WAGON_NUMBER\" TEXT);"); // 27: wagon_number
    }
    ...
    public Delivery readEntity(Cursor cursor, int offset) {
        Delivery entity = new Delivery( //
            ...
            cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23), // tl_number
            cursor.isNull(offset + 24) ? null : cursor.getString(offset + 24), // tl_transport_type
            cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25), // tl_transport_number
            cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26), // container_number
            cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27) // wagon_number
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Delivery entity, int offset) {
        ...
        entity.setTl_number(cursor.isNull(offset + 23) ? null : cursor.getString(offset + 23));
        entity.setTl_transport_type(cursor.isNull(offset + 24) ? null : cursor.getString(offset + 24));
        entity.setTl_transport_number(cursor.isNull(offset + 25) ? null : cursor.getString(offset + 25));
        entity.setContainer_number(cursor.isNull(offset + 26) ? null : cursor.getString(offset + 26));
        entity.setWagon_number(cursor.isNull(offset + 27) ? null : cursor.getString(offset + 27));
     }
