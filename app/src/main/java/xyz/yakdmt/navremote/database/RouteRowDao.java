...
public class RouteRowDao extends AbstractDao<RouteRow, String> {
    ...
    */
    public static class Properties {
        ...
        public final static Property Checkpoint_type = new Property(15, String.class, "checkpoint_type", false, "CHECKPOINT_TYPE");
        public final static Property Performer = new Property(16, String.class, "performer", false, "PERFORMER");
        public final static Property Performer_dept = new Property(17, String.class, "performer_dept", false, "PERFORMER_DEPT");
        public final static Property Active = new Property(18, String.class, "active", false, "ACTIVE");
        public final static Property Address = new Property(19, String.class, "address", false, "ADDRESS");
        public final static Property Checkpoint_id = new Property(20, String.class, "checkpoint_id", false, "CHECKPOINT_ID");
    };
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"ROUTE_ROW\" (" + //
                ...
                "\"CHECKPOINT_TYPE\" TEXT," + // 15: checkpoint_type
                "\"PERFORMER\" TEXT," + // 16: performer
                "\"PERFORMER_DEPT\" TEXT," + // 17: performer_dept
                "\"ACTIVE\" TEXT," + // 18: active
                "\"ADDRESS\" TEXT," + // 19: address
                "\"CHECKPOINT_ID\" TEXT);"); // 20: checkpoint_id
        // Add Indexes
    ...
    protected void bindValues(SQLiteStatement stmt, RouteRow entity) {
        ...
        if (checkpoint_id != null) {
            stmt.bindString(21, checkpoint_id);
        }
    }
    ...
    public RouteRow readEntity(Cursor cursor, int offset) {
        RouteRow entity = new RouteRow( //
            ...
            cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15), // checkpoint_type
            cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16), // performer
            cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17), // performer_dept
            cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18), // active
            cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19), // address
            cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20) // checkpoint_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, RouteRow entity, int offset) {
        ...
        entity.setCheckpoint_type(cursor.isNull(offset + 15) ? null : cursor.getString(offset + 15));
        entity.setPerformer(cursor.isNull(offset + 16) ? null : cursor.getString(offset + 16));
        entity.setPerformer_dept(cursor.isNull(offset + 17) ? null : cursor.getString(offset + 17));
        entity.setActive(cursor.isNull(offset + 18) ? null : cursor.getString(offset + 18));
        entity.setAddress(cursor.isNull(offset + 19) ? null : cursor.getString(offset + 19));
        entity.setCheckpoint_id(cursor.isNull(offset + 20) ? null : cursor.getString(offset + 20));
     }
