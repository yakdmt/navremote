...
public class Constants {
    ...
    public final static String[] FILENAME_ARRAY = {"Пример Грузы", "Пример Доставки", "Пример Клиенты", "Пример Комментарии",
            "Пример Контакты", "Пример Маршруты", "Пример Пункты", "Пример Работы" };

    public final static Class[] CLASSES_ARRAY = {Cargo.class, Delivery.class, Client.class, Comment.class,
